...
//    assertNull("Overdue date should be null", forecastActualList.get(7).getOverdueDate());
  ...
  @Test
  public void testLongDate() throws IOException, ParseException {
    String rsp =
    "MSH|^~\\&|DOCKET_IIS|DOCKET||60a77cf1-b44a-44cc-ad13-6d31078e29f4|20260604212717||RSP^K11^RSP_K11|5c0e7b29-72a3-4c90-99db-5d29c28243b4|T|2.5.1|||NE|NE|||||Z42^CDCPHINVS\r\n"
    + "MSA|AA|ART-HIB-2tfEHcF\r\n"
    + "QAK|ART-HIB-2tfEHcF|OK|Z44^Request Evaluated History and Forecast^CDCPHINVS\r\n"
    + "QPD|Z44^Request Evaluated History and Forecast^CDCPHINVS|ART-HIB-2tfEHcF|ART-HIB-2tfEHcF^^^FITS^MR|FranklinAIRA^AkankeAIRA^Garett^^^^L|SierraAIRA^WynonaAIRA^^^^^M|20260401|F|227 Hickman Cir^^Bloomfield^MI^48304^USA^P\r\n"
    + "PID|1|7fa3e884-a601-4b29-a365-7156c2808183|ART-HIB-2tfEHcF^^^FITS^MR||FranklinAIRA^AkankeAIRA^Garett^^^^L|SierraAIRA^WynonaAIRA^^^^^M|20260401000000|F|||227 Hickman Cir^^Bloomfield^MI^48304^USA^L||^PRN^^||^|||||||||||||||\r\n"
    + "PD1||||||||||||||||\r\n"
    + "NK1|1|Luzerne^Wynona^|MTH|^^^^^^L|^PRN^^||C||||||||||||||||||||||||||||||||N\r\n"
    + "ORC|RE||ART-HIB-2tfEHcF.1^FITS|||||||||^^|||||FITS\r\n"
    + "RXA|0|1|20260601000000|20260601000000|17^17|999|||01|^^|^^^||||||^||||\r\n"
    + "OBX|1|CE|30956-7^Vaccine type^LN|1|17^HIB^CVX||||||F|||20260604212717\r\n"
    + "OBX|2|ID|59781-5^Dose validity^LN|1|N||||||F|||20260604212717\r\n"
    + "OBX|3|CE|30982-3^Reason for validity^LN|1|DUPLICATE_SAME_DAY^This immunization event is a duplicate.^2.16.840.1.113883.3.795.12.100.3||||||F|||20260604212717\r\n"
    + "OBX|4|CE|59779-9^Schedule used^LN|1|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|5|CE|59780-7^Series name^LN|1|17^HIB^L||||||F|||20260604212717\r\n"
    + "ORC|RE||ART-HIB-2tfEHcF.1^FITS|||||||||^^|||||FITS\r\n"
    + "RXA|0|1|20260601000000|20260601000000|17^17|999|||01|^^|^^^||||||^||||\r\n"
    + "OBX|6|CE|30956-7^Vaccine type^LN|1|17^HIB^CVX||||||F|||20260604212717\r\n"
    + "OBX|7|ID|59781-5^Dose validity^LN|1|N||||||F|||20260604212717\r\n"
    + "OBX|8|CE|30982-3^Reason for validity^LN|1|DUPLICATE_SAME_DAY^This immunization event is a duplicate.^2.16.840.1.113883.3.795.12.100.3||||||F|||20260604212717\r\n"
    + "OBX|9|CE|59779-9^Schedule used^LN|1|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|10|CE|59780-7^Series name^LN|1|17^HIB^L||||||F|||20260604212717\r\n"
    + "ORC|RE||ART-HIB-2tfEHcF.1^FITS|||||||||^^|||||FITS\r\n"
    + "RXA|0|1|20260601000000|20260601000000|17^17|999|||01|^^|^^^||||||^||||\r\n"
    + "OBX|11|CE|30956-7^Vaccine type^LN|1|17^HIB^CVX||||||F|||20260604212717\r\n"
    + "OBX|12|ID|59781-5^Dose validity^LN|1|N||||||F|||20260604212717\r\n"
    + "OBX|13|CE|30982-3^Reason for validity^LN|1|DUPLICATE_SAME_DAY^This immunization event is a duplicate.^2.16.840.1.113883.3.795.12.100.3||||||F|||20260604212717\r\n"
    + "OBX|14|CE|59779-9^Schedule used^LN|1|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|15|CE|59780-7^Series name^LN|1|17^HIB^L||||||F|||20260604212717\r\n"
    + "ORC|RE||ART-HIB-2tfEHcF.1^FITS|||||||||^^|||||FITS\r\n"
    + "RXA|0|1|20260601000000|20260601000000|17^17|999|||01|^^|^^^||||||^||||\r\n"
    + "OBX|16|CE|30956-7^Vaccine type^LN|1|17^HIB^CVX||||||F|||20260604212717\r\n"
    + "OBX|17|ID|59781-5^Dose validity^LN|1|N||||||F|||20260604212717\r\n"
    + "OBX|18|CE|30982-3^Reason for validity^LN|1|DUPLICATE_SAME_DAY^This immunization event is a duplicate.^2.16.840.1.113883.3.795.12.100.3||||||F|||20260604212717\r\n"
    + "OBX|19|CE|59779-9^Schedule used^LN|1|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|20|CE|59780-7^Series name^LN|1|17^HIB^L||||||F|||20260604212717\r\n"
    + "ORC|RE||ART-HIB-2tfEHcF.1^FITS|||||||||^^|||||FITS\r\n"
    + "RXA|0|1|20260601000000|20260601000000|17^17|999|||01|^^|^^^||||||^||||\r\n"
    + "OBX|21|CE|30956-7^Vaccine type^LN|1|17^HIB^CVX||||||F|||20260604212717\r\n"
    + "OBX|22|ID|59781-5^Dose validity^LN|1|Y||||||F|||20260604212717\r\n"
    + "OBX|23|CE|59779-9^Schedule used^LN|1|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|24|CE|59780-7^Series name^LN|1|17^HIB^L||||||F|||20260604212717\r\n"
    + "ORC|RE||9999\r\n"
    + "RXA|0|1|20260604212717|20260604212717|998^No Vaccine Administered^CVX|999||||||||||||||NA|A\r\n"
    + "OBX|25|CE|30956-7^Vaccine type^LN|1|45^HepB^CVX||||||F|||20260604212717\r\n"
    + "OBX|26|CE|59783-1^Status in the immunization series^LN|1|LA13423-1^Overdue^LA||||||F|||20260604212717\r\n"
    + "OBX|27|DT|30981-5^Earliest date^LN|1|20260401000000||||||F|||20260604212717\r\n"
    + "OBX|28|DT|30980-7^Recommended date^LN|1|20260401000000||||||F|||20260604212717\r\n"
    + "OBX|29|DT|59778-1^Overdue date^LN|1|20260428000000||||||F|||20260604212717\r\n"
    + "OBX|30|DT|59777-3^Latest date^LN|1|20260401000000||||||F|||20260604212717\r\n"
    + "OBX|31|CE|59779-9^Schedule used^LN|1|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|32|CE|59780-7^Series name^LN|1|45^HepB^L||||||F|||20260604212717\r\n"
    + "OBX|33|CE|30956-7^Vaccine type^LN|2|122^ROTAVIRUS^CVX||||||F|||20260604212717\r\n"
    + "OBX|34|CE|59783-1^Status in the immunization series^LN|2|LA13423-1^Overdue^LA||||||F|||20260604212717\r\n"
    + "OBX|35|DT|30981-5^Earliest date^LN|2|20260513000000||||||F|||20260604212717\r\n"
    + "OBX|36|DT|30980-7^Recommended date^LN|2|20260601000000||||||F|||20260604212717\r\n"
    + "OBX|37|DT|59778-1^Overdue date^LN|2|20260601000000||||||F|||20260604212717\r\n"
    + "OBX|38|DT|59777-3^Latest date^LN|2|20260601000000||||||F|||20260604212717\r\n"
    + "OBX|39|CE|59779-9^Schedule used^LN|2|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|40|CE|59780-7^Series name^LN|2|122^ROTAVIRUS^L||||||F|||20260604212717\r\n"
    + "OBX|41|CE|30956-7^Vaccine type^LN|3|107^DTAP^CVX||||||F|||20260604212717\r\n"
    + "OBX|42|CE|59783-1^Status in the immunization series^LN|3|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|43|DT|30981-5^Earliest date^LN|3|20260513000000||||||F|||20260604212717\r\n"
    + "OBX|44|DT|30980-7^Recommended date^LN|3|20260601000000||||||F|||20260604212717\r\n"
    + "OBX|45|DT|59778-1^Overdue date^LN|3|20260728000000||||||F|||20260604212717\r\n"
    + "OBX|46|DT|59777-3^Latest date^LN|3|20260601000000||||||F|||20260604212717\r\n"
    + "OBX|47|CE|59779-9^Schedule used^LN|3|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|48|CE|59780-7^Series name^LN|3|107^DTAP^L||||||F|||20260604212717\r\n"
    + "OBX|49|CE|30956-7^Vaccine type^LN|4|33^PneumoPPV^CVX||||||F|||20260604212717\r\n"
    + "OBX|50|CE|59783-1^Status in the immunization series^LN|4|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|51|DT|30981-5^Earliest date^LN|4|20260513000000||||||F|||20260604212717\r\n"
    + "OBX|52|DT|30980-7^Recommended date^LN|4|20260601000000||||||F|||20260604212717\r\n"
    + "OBX|53|DT|59778-1^Overdue date^LN|4|20260728000000||||||F|||20260604212717\r\n"
    + "OBX|54|DT|59777-3^Latest date^LN|4|20260601000000||||||F|||20260604212717\r\n"
    + "OBX|55|CE|59779-9^Schedule used^LN|4|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|56|CE|59780-7^Series name^LN|4|33^PneumoPPV^L||||||F|||20260604212717\r\n"
    + "OBX|57|CE|30956-7^Vaccine type^LN|5|89^POLIO^CVX||||||F|||20260604212717\r\n"
    + "OBX|58|CE|59783-1^Status in the immunization series^LN|5|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|59|DT|30981-5^Earliest date^LN|5|20260513000000||||||F|||20260604212717\r\n"
    + "OBX|60|DT|30980-7^Recommended date^LN|5|20260601000000||||||F|||20260604212717\r\n"
    + "OBX|61|DT|59778-1^Overdue date^LN|5|20260728000000||||||F|||20260604212717\r\n"
    + "OBX|62|DT|59777-3^Latest date^LN|5|20260601000000||||||F|||20260604212717\r\n"
    + "OBX|63|CE|59779-9^Schedule used^LN|5|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|64|CE|59780-7^Series name^LN|5|89^POLIO^L||||||F|||20260604212717\r\n"
    + "OBX|65|CE|30956-7^Vaccine type^LN|6|213^COVID-19^CVX||||||F|||20260604212717\r\n"
    + "OBX|66|CE|59783-1^Status in the immunization series^LN|6|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|67|DT|30981-5^Earliest date^LN|6|20261001000000||||||F|||20260604212717\r\n"
    + "OBX|68|DT|30980-7^Recommended date^LN|6|20261001000000||||||F|||20260604212717\r\n"
    + "OBX|69|DT|59778-1^Overdue date^LN|6|20261001000000||||||F|||20260604212717\r\n"
    + "OBX|70|DT|59777-3^Latest date^LN|6|20261001000000||||||F|||20260604212717\r\n"
    + "OBX|71|CE|59779-9^Schedule used^LN|6|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|72|CE|59780-7^Series name^LN|6|213^COVID-19^L||||||F|||20260604212717\r\n"
    + "OBX|73|CE|30956-7^Vaccine type^LN|7|88^FLU^CVX||||||F|||20260604212717\r\n"
    + "OBX|74|CE|59783-1^Status in the immunization series^LN|7|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|75|DT|30981-5^Earliest date^LN|7|20261001000000||||||F|||20260604212717\r\n"
    + "OBX|76|DT|30980-7^Recommended date^LN|7|20261001000000||||||F|||20260604212717\r\n"
    + "OBX|77|DT|59778-1^Overdue date^LN|7|20261001000000||||||F|||20260604212717\r\n"
    + "OBX|78|DT|59777-3^Latest date^LN|7|20261001000000||||||F|||20260604212717\r\n"
    + "OBX|79|CE|59779-9^Schedule used^LN|7|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|80|CE|59780-7^Series name^LN|7|88^FLU^L||||||F|||20260604212717\r\n"
    + "OBX|81|CE|30956-7^Vaccine type^LN|8|85^HepA^CVX||||||F|||20260604212717\r\n"
    + "OBX|82|CE|59783-1^Status in the immunization series^LN|8|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|83|DT|30981-5^Earliest date^LN|8|20270401000000||||||F|||20260604212717\r\n"
    + "OBX|84|DT|30980-7^Recommended date^LN|8|20270401000000||||||F|||20260604212717\r\n"
    + "OBX|85|DT|59778-1^Overdue date^LN|8|20280428000000||||||F|||20260604212717\r\n"
    + "OBX|86|DT|59777-3^Latest date^LN|8|20270401000000||||||F|||20260604212717\r\n"
    + "OBX|87|CE|59779-9^Schedule used^LN|8|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|88|CE|59780-7^Series name^LN|8|85^HepA^L||||||F|||20260604212717\r\n"
    + "OBX|89|CE|30956-7^Vaccine type^LN|9|17^HIB^CVX||||||F|||20260604212717\r\n"
    + "OBX|90|CE|59783-1^Status in the immunization series^LN|9|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|91|DT|30981-5^Earliest date^LN|9|20260629000000||||||F|||20260604212717\r\n"
    + "OBX|92|DT|30980-7^Recommended date^LN|9|20260801000000||||||F|||20260604212717\r\n"
    + "OBX|93|DT|59778-1^Overdue date^LN|9|20260928000000||||||F|||20260604212717\r\n"
    + "OBX|94|DT|59777-3^Latest date^LN|9|20260801000000||||||F|||20260604212717\r\n"
    + "OBX|95|CE|59779-9^Schedule used^LN|9|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|96|CE|59780-7^Series name^LN|9|17^HIB^L||||||F|||20260604212717\r\n"
    + "OBX|97|CE|30956-7^Vaccine type^LN|10|137^HPV^CVX||||||F|||20260604212717\r\n"
    + "OBX|98|CE|59783-1^Status in the immunization series^LN|10|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|99|DT|30981-5^Earliest date^LN|10|20350401000000||||||F|||20260604212717\r\n"
    + "OBX|100|DT|30980-7^Recommended date^LN|10|20370401000000||||||F|||20260604212717\r\n"
    + "OBX|101|DT|59778-1^Overdue date^LN|10|20390428000000||||||F|||20260604212717\r\n"
    + "OBX|102|DT|59777-3^Latest date^LN|10|20370401000000||||||F|||20260604212717\r\n"
    + "OBX|103|CE|59779-9^Schedule used^LN|10|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|104|CE|59780-7^Series name^LN|10|137^HPV^L||||||F|||20260604212717\r\n"
    + "OBX|105|CE|30956-7^Vaccine type^LN|11|108^MENING^CVX||||||F|||20260604212717\r\n"
    + "OBX|106|CE|59783-1^Status in the immunization series^LN|11|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|107|DT|30981-5^Earliest date^LN|11|20370401000000||||||F|||20260604212717\r\n"
    + "OBX|108|DT|30980-7^Recommended date^LN|11|20370401000000||||||F|||20260604212717\r\n"
    + "OBX|109|DT|59778-1^Overdue date^LN|11|20390428000000||||||F|||20260604212717\r\n"
    + "OBX|110|DT|59777-3^Latest date^LN|11|20370401000000||||||F|||20260604212717\r\n"
    + "OBX|111|CE|59779-9^Schedule used^LN|11|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|112|CE|59780-7^Series name^LN|11|108^MENING^L||||||F|||20260604212717\r\n"
    + "OBX|113|CE|30956-7^Vaccine type^LN|12|03^MMR^CVX||||||F|||20260604212717\r\n"
    + "OBX|114|CE|59783-1^Status in the immunization series^LN|12|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|115|DT|30981-5^Earliest date^LN|12|20270401000000||||||F|||20260604212717\r\n"
    + "OBX|116|DT|30980-7^Recommended date^LN|12|20270401000000||||||F|||20260604212717\r\n"
    + "OBX|117|DT|59778-1^Overdue date^LN|12|20270828000000||||||F|||20260604212717\r\n"
    + "OBX|118|DT|59777-3^Latest date^LN|12|20270401000000||||||F|||20260604212717\r\n"
    + "OBX|119|CE|59779-9^Schedule used^LN|12|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|120|CE|59780-7^Series name^LN|12|03^MMR^L||||||F|||20260604212717\r\n"
    + "OBX|121|CE|30956-7^Vaccine type^LN|13|21^VARICELLA^CVX||||||F|||20260604212717\r\n"
    + "OBX|122|CE|59783-1^Status in the immunization series^LN|13|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|123|DT|30981-5^Earliest date^LN|13|20270401000000||||||F|||20260604212717\r\n"
    + "OBX|124|DT|30980-7^Recommended date^LN|13|20270401000000||||||F|||20260604212717\r\n"
    + "OBX|125|DT|59778-1^Overdue date^LN|13|20270828000000||||||F|||20260604212717\r\n"
    + "OBX|126|DT|59777-3^Latest date^LN|13|20270401000000||||||F|||20260604212717\r\n"
    + "OBX|127|CE|59779-9^Schedule used^LN|13|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|128|CE|59780-7^Series name^LN|13|21^VARICELLA^L||||||F|||20260604212717\r\n"
    + "OBX|129|CE|30956-7^Vaccine type^LN|14|188^ZOSTER^CVX||||||F|||20260604212717\r\n"
    + "OBX|130|CE|59783-1^Status in the immunization series^LN|14|LA13422-3^On schedule^LA||||||F|||20260604212717\r\n"
    + "OBX|131|DT|30981-5^Earliest date^LN|14|20760401000000||||||F|||20260604212717\r\n"
    + "OBX|132|DT|30980-7^Recommended date^LN|14|20760401000000||||||F|||20260604212717\r\n"
    + "OBX|133|DT|59778-1^Overdue date^LN|14|20760401000000||||||F|||20260604212717\r\n"
    + "OBX|134|DT|59777-3^Latest date^LN|14|20760401000000||||||F|||20260604212717\r\n"
    + "OBX|135|CE|59779-9^Schedule used^LN|14|VXC16^ACIP^CDCPHINVS||||||F|||20260604212717\r\n"
    + "OBX|136|CE|59780-7^Series name^LN|14|188^ZOSTER^L||||||F|||20260604212717\r\n";
    
    TestCase output = IISConnector.recreateTestCase(rsp);
    
    assertEquals(5, output.getTestEventList().size());
    
    Calendar cal = Calendar.getInstance();
    cal.set(2026, 5, 1, 0, 0, 0);
    cal.set(Calendar.MILLISECOND, 0);
    
    Date expected = cal.getTime();
    
    for (TestEvent event : output.getTestEventList()) {
      assertEquals(expected, event.getEventDate());
    }
  }
}
