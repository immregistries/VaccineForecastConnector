                                    ...
                                    if (localCodeType != null){
                                        writeAttribute("",
                                          ...
                                          throw new org.apache.axis2.databinding.ADBException("required attribute localCodeType is null");
                                           ...
                                           localVaccCode.serialize(new javax.xml.namespace.QName("http://saf.stchome.com/messages/get/1.2","vaccCode"),
                                               xmlWriter);
                                        
                                            if (localVaccDate==null){
                                                 throw new org.apache.axis2.databinding.ADBException("vaccDate cannot be null!!");
                                            }
                                           localVaccDate.serialize(new javax.xml.namespace.QName("http://saf.stchome.com/messages/get/1.2","vaccDate"),
                                               xmlWriter);
                                       ...
                                       if (localMessage!=null){
                                            for (int i = 0;i < localMessage.length;i++){
                                                if (localMessage[i] != null){
                                                 localMessage[i].serialize(new javax.xml.namespace.QName("http://saf.stchome.com/messages/get/1.2","message"),
                                                           xmlWriter);
                                                } else {
                   ...
                   if (tempAttribCodeType!=null){
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://saf.stchome.com/messages/get/1.2","vaccCode").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://saf.stchome.com/messages/get/1.2","vaccDate").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://saf.stchome.com/messages/get/1.2","doseSize").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://saf.stchome.com/messages/get/1.2","message").equals(reader.getName())){
                                    ...
                                    list4.add(com.stchome.saf.common.VaccMessageType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://saf.stchome.com/messages/get/1.2","message").equals(reader.getName())){
                                                                    list4.add(com.stchome.saf.common.VaccMessageType.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://saf.stchome.com/messages/get/1.2","compromisedCode").equals(reader.getName())){
