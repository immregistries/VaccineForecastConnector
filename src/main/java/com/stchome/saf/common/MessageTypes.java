...
public class MessageTypes implements java.io.Serializable {
    ...
    public static final java.lang.String _value1 = "WARNING";
    public static final java.lang.String _value2 = "INVALID-VACC";
    public static final MessageTypes value1 = new MessageTypes(_value1);
    public static final MessageTypes value2 = new MessageTypes(_value2);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://saf.stchome.com/common", "MessageTypes"));
    }
    /**
